...
if(isset($_POST['submit'])){
    ...
    if(!is_writable($uploadDir)){
        die("Error: product_img folder is not writable.");
    }
    ...
    if(isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK){
        ...
        if(!move_uploaded_file($_FILES['image']['tmp_name'], $uploadDir.$targetFile)){
    ...
    try{
        ...
        $insertQuery = "INSERT INTO products(name, price, image)
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Prodcuts</h5>
